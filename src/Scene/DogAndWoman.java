...
public class DogAndWoman extends JPanel implements MouseListener{
	...
	public DogAndWoman() {
		try {
			...
			leftImage = ImageIO.read( new File( "images/scene1/left.png" ) ) ;
			rightImage = ImageIO.read( new File( "images/scene1/right.png" ) ) ;
	...
	public void mouseClicked(MouseEvent e) {
		...
		int x = e.getX() ;
		int y = e.getY() ;
		System.out.println( "鼠标点击的数组：" ) ;
		System.out.println( "X:"+x/50+"    Y:"+y/80 ) ;
